...
TankBuffReminderConfig = {
    ...
    -- Buffs to auto-cancel whenever detected 
    autoRemove = {
        {
            key           = "salvation",
	...
	sounds = {
		...
		{ name = "C'Thun",               id = 8586 },
		{ name = "Druid of the Claw",    id = 6208 },
    ...
    consumables = {
		...
		{ key="crystalHealing",      label="Crystal Healing Potion",    category="Potions", itemIDs={33934}, icon="Interface\\Icons\\inv_potion_167", defaultOn=true,  isPotionType=true, druidInstant=true, druidWarn=false },
		{ key="crystalMana",         label="Crystal Mana Potion",       category="Potions", itemIDs={33935}, icon="Interface\\Icons\\inv_potion_168", defaultOn=true,  isPotionType=true, druidInstant=true, druidWarn=false },
		{ key="redOgreBrew",         label="Red Ogre Brew Special",     category="Potions", itemIDs={32910}, icon="Interface\\Icons\\inv_potion_165", defaultOn=false, isPotionType=true, druidInstant=true, druidWarn=false },
		{ key="blueOgreBrew",        label="Blue Ogre Brew Special",    category="Potions", itemIDs={32909}, icon="Interface\\Icons\\inv_potion_166", defaultOn=false, isPotionType=true, druidInstant=true, druidWarn=false },
		...
		{ key="unstableBandit",      label="Unstable Flask of the Bandit",    category="Flasks", itemIDs={32599}, icon="Interface\\Icons\\inv_potion_156", defaultOn=false, druidInstant=true, druidWarn=false },
		{ key="unstableSoldier",     label="Unstable Flask of the Soldier",   category="Flasks", itemIDs={32597}, icon="Interface\\Icons\\inv_potion_155", defaultOn=false, druidInstant=true, druidWarn=false },
		...
		{ key="healingInjector",     label="Healing Potion Injector",   category="Engineering", itemIDs={33092}, icon="Interface\\Icons\\inv_gizmo_newgoggles", defaultOn=false, isPotionType=true, druidInstant=true, druidWarn=false },
		{ key="manaInjector",        label="Mana Potion Injector",      category="Engineering", itemIDs={33093}, icon="Interface\\Icons\\inv_gizmo_newgoggles", defaultOn=false, isPotionType=true, druidInstant=true, druidWarn=false },
